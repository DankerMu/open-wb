...
- [ ] 2.3 Homebrew Bash PATH: make guard, make test-guardrails, make check; Linux Ubuntu 24.04 direct probes if available plus required PR CI anti-drift. Selected docs pack maps to strict OpenSpec validation and this fixture.
