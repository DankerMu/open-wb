...
- [ ] 1.5 Round-one data-integrity repair implemented: permanent semantic RED/GREEN rejects isolated high/low surrogates before mutation; supplementary/U+FFFD identity survives real SQLite/list/audit. Main identical counterexample and strict real DB/FS policy oracle now GREEN; focused80/4, fullserver964/44 and all eight static/type/build/test gates pass. Exact non-u derivation and prior boundaries remain. Fresh correctness/evidence review and repaired-head CI are still required.
