...
- [ ] 2.3 Full Web test/coverage, build and default make check pass; strict OpenSpec validation; Phase2 audit confirms fixture-only diff with no weakening, tier none review-not-required record bound to final SHA plus required CI.
