...
- [x] 5.5 #132 / PR257 finalba95ced merge8f6d033；PR CI35977941147与merged-master CI35978802687九项全绿（uid job107565512880）。15min正式uidjob、3SETENV规则/globalvisudo/精确HOME/有效共享组两阶段，未改#131的真实uid/proc断言1pass0skip，真实omp四文件38请求绿；可选OMP_USER及精确8direct/8checkout/6setup-node原子接线。Guardrails705PASS0FAIL；只TERMwrapper与leader7残留组均先RED后GREEN，boundedcleanup不碰sentinel。expanded三席+两fixpasses+fresh/integrationreview最终clean。保留#107控制面，Width exception: multi-path；5.6降级删除仍独立处理。
