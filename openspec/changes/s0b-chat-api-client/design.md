...
Subsequently upstream PR #237 independently merged the full #235/#236 readiness-oracle repair. Integration takes its files-page test verbatim; this PR's final diff contains no files-page test change. The temporary exception above records the earlier reviewed CI repair, not an additional implementation alongside upstream.
