...
- [x] 1.6 Fixpass1 implemented user-approved shared sudo PATH policy at config+spawn, permanent actual-entry forwarding regression and both-mode idle-reopen identity. Main native scratch-sudo RED1→rejectGREEN0; actual compiled entry six unsafePATH classes exit1/noeffects. Exact committed-test scratch copies baseline0/drop-server-forwardRED1/default-only-resumeRED1/restored0. Main eight gates0, focused100/8/full1156/62(lines92.18%,branches88.32%)/dupes0. NUL rawvalidator tested because process.env cannot retain NUL; direct absent-user behavior preserved. Final review closed all findings and CI35806224549 passed at 7bb80dfc2a45a9caad935f18d3bd1e08b3fa42c7.
- [x] 1.5 Expanded static review and one substantive fix pass complete; intermediate helper staging omission corrected and exact-head reviewer confirmation obtained before green CI/merge. PR #215 merged as 8cdfc02; public evidence https://github.com/DankerMu/open-wb/pull/215#issuecomment-5787393412. Selective archive promotes only these two requirements; parent remains active, directory/DB permissions belong to #126 and Linux uid proof to #131/#132.
## 2. Risk mapping
