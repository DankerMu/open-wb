...
- Fatal startup failure terminates the child; pending requests fail on exit/IO errors; timers and pending state clear. Exit observation includes code and signal exactly once. Spawn errors reject without uncaught EventEmitter errors.
