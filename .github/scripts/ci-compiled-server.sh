...
hpid=$!; trap 'trap '\''pending=1'\'' TERM INT; pending=1; exit 143' TERM INT; honor_cancel; set +m; galive "$hpid" || { echo "harness PGID contract failed (pid ${hpid})" >&2; cleanup_rc=1; }
